...
def config_parser(cmd=None):
    ...
    parser.add_argument("--vm_agg_mode", type=int, default=1,
                        help='0 for concat, 1 for add')
    parser.add_argument("--vm_sep_mat", type=int, default=0,
                        help='0 for use same mat for all, 1 use for each direction, 2 use for each one tensorf')
    parser.add_argument("--vm_dim_factor", type=float, default=1.0,
                        help='vm can have higher dim than cp')
    parser.add_argument("--mat_den_l1", type=int, default=1,
                        help='0 for no den l1 on mat, 1 for has den l1 on mat')
    # network decoder
